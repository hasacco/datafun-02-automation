...
git clone https://github.com/hasacco/datafun-02-automation
...
## Modifications 5-21-26

User was asked to input their name as a string in order to personalize pet data files.
PET_LIST was changed from a global constant to a global variable that requires user input of 3 pets rather than using 3 static pets.
All written files that were previously case_filename.txt were changed to hasacco_filename.txt.
Function 2 and Function 3 were changed from static variables to user input variables that then write personalized output files with user name and pets.

## Example Output 5-21-26
Enter your name: Bob
Enter a type of pet: Alpaca
Enter another type of pet: Dog
Enter one more type of pet: Bird
| P02 | === RUN START ===
| P02 | project=P02
| P02 | repo_dir=datafun-02-automation
| P02 | python=3.14.5
| P02 | os=Windows 11
| P02 | shell=powershell
| P02 | cwd=.
...
| P02 | First quarter: 1
| P02 | Last quarter:  4
| P02 | Wrote file: hasacco_quarter_1.txt
| P02 | Wrote file: hasacco_quarter_2.txt
| P02 | Wrote file: hasacco_quarter_3.txt
| P02 | Wrote file: hasacco_quarter_4.txt
| P02 | ========================
| P02 | FUNCTION 2: for loop over a list
| P02 | ========================
| P02 | Pet list: ['Alpaca', 'Dog', 'Bird']
| P02 | Wrote file: Bob_Alpaca.txt
| P02 | Wrote file: Bob_Dog.txt
| P02 | Wrote file: Bob_Bird.txt
| P02 | ========================
| P02 | FUNCTION 3: list comprehension
| P02 | ========================
| P02 | Original list: ['Alpaca', 'Dog', 'Bird']
| P02 | Transformed list: ['favorite_Alpaca', 'favorite_Dog', 'favorite_Bird']
| P02 | Wrote file: Bob_favorite_Alpaca.txt
| P02 | Wrote file: Bob_favorite_Dog.txt
| P02 | Wrote file: Bob_favorite_Bird.txt
| P02 | ========================
| P02 | FUNCTION 4: while loop with counter
| P02 | ========================
| P02 | Files to create: 3
| P02 | Seconds between files: 1
| P02 | Wrote file: hasacco_01.txt
| P02 | Waiting 1 second(s)...
| P02 | Wrote file: hasacco_02.txt
| P02 | Waiting 1 second(s)...
| P02 | Wrote file: hasacco_03.txt
| P02 | Waiting 1 second(s)...
| P02 | ========================
| P02 | Executed successfully!
| P02 | ========================
